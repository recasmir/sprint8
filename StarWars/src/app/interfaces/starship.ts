// To parse this data:
//
//   import { Convert, SearchStarshipsResponse } from "./file";
//
//   const searchStarshipsResponse = Convert.toSearchStarshipsResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchStarshipsResponse {
    count:    number;
    next:     string;
    previous: null;
    results:  Starship[];
...
export class Convert {
    public static toSearchStarshipsResponse(json: string): SearchStarshipsResponse {
        return cast(JSON.parse(json), r("SearchStarshipsResponse"));
    }

    public static searchStarshipsResponseToJson(value: SearchStarshipsResponse): string {
        return JSON.stringify(uncast(value, r("SearchStarshipsResponse")), null, 2);
    }
}
